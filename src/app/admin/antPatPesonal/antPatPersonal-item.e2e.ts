...
import { AntPatPersonalListPageObject } from './antPatPersonal-list.po';
import { AntPatPersonalItemPageObject } from './antPatPersonal-item.po';
import { AntPatPersonal } from '../services/api/models/antPatPersonal';
...
describe('Type Of Type Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new AntPatPersonalListPageObject();
    let itemPO = new AntPatPersonalItemPageObject();
    let listWithCount = require('../services/api/local/TypeOfType.json');
    let metaData = require('./antPatPersonal.metadata.json');
