...
import { FiliacionListPageObject } from './filiacion-list.po';
import { FiliacionItemPageObject } from './filiacion-item.po';
...
describe('Ncg Validation Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new FiliacionListPageObject();
    let itemPO = new FiliacionItemPageObject();
    let listWithCount = require('../services/api/local/NcgValidation.json');
    let metaData = require('./filiacion.metadata.json');
