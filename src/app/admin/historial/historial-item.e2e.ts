...
import { HistorialListPageObject } from './historial-list.po';
import { HistorialItemPageObject } from './historial-item.po';
...
describe('Default Validation Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new HistorialListPageObject();
    let itemPO = new HistorialItemPageObject();
    let listWithCount = require('../services/api/local/DefaultValidation.json');
    let metaData = require('./historial.metadata.json');
