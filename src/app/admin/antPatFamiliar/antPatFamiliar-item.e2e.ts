...
import { AntPatFamiliarListPageObject } from './antPatFamiliar-list.po';
import { AntPatFamiliarItemPageObject } from './antPatFamiliar-item.po';
...
describe('Ncg Type And Format Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new AntPatFamiliarListPageObject();
    let itemPO = new AntPatFamiliarItemPageObject();
    let listWithCount = require('../services/api/local/NcgTypeAndFormat.json');
    let metaData = require('./antPatFamiliar.metadata.json');
