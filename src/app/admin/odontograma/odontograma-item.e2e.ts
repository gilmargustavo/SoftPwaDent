...
import { OdontogramaListPageObject } from './odontograma-list.po';
import { OdontogramaItemPageObject } from './odontograma-item.po';
...
describe('Ncg Other Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new OdontogramaListPageObject();
    let itemPO = new OdontogramaItemPageObject();
    let listWithCount = require('../services/api/local/NcgOther.json');
    let metaData = require('./odontograma.metadata.json');
