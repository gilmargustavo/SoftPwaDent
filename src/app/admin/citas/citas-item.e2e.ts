...
import { CitasListPageObject } from './citas-list.po';
import { CitasItemPageObject } from './citas-item.po';
...
describe('Tenant Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new CitasListPageObject();
    let itemPO = new CitasItemPageObject();
    let listWithCount = require('../services/api/local/Tenant.json');
    let metaData = require('./citas.metadata.json');
