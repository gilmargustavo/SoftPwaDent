...
import { LoginListPageObject } from './login-list.po';
import { LoginItemPageObject } from './login-item.po';
...
describe('Default Type And Format Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new LoginListPageObject();
    let itemPO = new LoginItemPageObject();
    let listWithCount = require('../services/api/local/DefaultTypeAndFormat.json');
    let metaData = require('./login.metadata.json');
