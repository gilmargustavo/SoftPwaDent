...
export abstract class BaseListComponent<T> implements OnInit {
  ...
  public personal(item) {
    this.id = item.$key;
    this.router.navigate(['../../antPatPersonal', this.id], { relativeTo: this.activatedRoute });
  }

  public regPaciente() {
    this.router.navigate(['../../filiacion/new'], { relativeTo: this.activatedRoute });
  }

  public regTratamiento() {
    this.router.navigate(['../../odontograma/new'], { relativeTo: this.activatedRoute });
  }

  public regCita() {
    this.router.navigate(['../../citas/new'], { relativeTo: this.activatedRoute });
  }

  public odontograma(item) {
    this.id = item.$key;
    this.router.navigate(['../../odontograma', this.id], { relativeTo: this.activatedRoute });
  }

  public historial(item) {
    this.id = item.$key;
    this.router.navigate(['../../odontograma', this.id], { relativeTo: this.activatedRoute });
  }

  public registrarCita(item) {
    this.id = item.$key;
    this.router.navigate(['../../citas', this.id], { relativeTo: this.activatedRoute });
  }

  public familiar(item) {
    this.id = item.$key;
    this.router.navigate(['../../antPatFamiliar', this.id], { relativeTo: this.activatedRoute });
  }

  public odonto() {
    this.router.navigate(['../../historial'], { relativeTo: this.activatedRoute });
  }
  ...
  public editFamiliar(item) {
    this.id = item.$key;
    this.router.navigate(['../../antPatFamiliar', this.id], { relativeTo: this.activatedRoute });
  }

  public editPersonal(item) {
    this.id = item.$key;
    this.router.navigate(['../../antPatPersonal', this.id], { relativeTo: this.activatedRoute });
  }
